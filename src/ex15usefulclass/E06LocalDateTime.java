...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		...
		Period 클래스 : 두 날짜 사이의 간격을 나타낸다.
			?개월 ?일 남음으로 표시할 수 있다. */
		Period period = Period.between(localTime, xMas);
		...
		//남은 개월 수 표시
		System.out.println
		(ChronoUnit.MONTHS.between(localDate, xMas) +"개월 남음");
		//남은 일수 표시
		System.out.println
		(ChronoUnit.DAYS.between(localDate, xMas) +"일 남음");
