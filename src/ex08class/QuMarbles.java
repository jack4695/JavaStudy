...
class ChildProperty {
    private int bead; // 어린이가 보유한 구슬 개수
    ...
    // 구슬을 얻거나 잃는 메서드
    public void obtainBead(ChildProperty child, int count) {  //<<--other라는 변수 형태 기억하기.
        child.bead -= count; // 상대방의 구슬 개수 감소
        this.bead += count; // 자신의 구슬 개수 증가
        } 
